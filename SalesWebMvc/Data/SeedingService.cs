...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext context)//injeçao de dependência
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            //Testando se tem algo na base de dados
            ...
            Department d1 = new Department(1,"Departments");
